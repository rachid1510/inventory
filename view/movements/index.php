...
include ("layouts/header.php");?>
 ...
 <!-- Modal create -->
                ...
                <div class="modal-body">
                    ...
                    <form id="addmovement" class="form-horizontal" role="form" enctype="multipart/form-data" action="movement/add" method="POST" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="provider" class="form-control" id="">
                                  <option>Four1</option>
                                  <option>Four2</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="date"  class="form-control datePicker" name="date_arrived" id="">
                                <small class="help-block"></small>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4 pull-right">
                                <a title="movement/add" alt="addmovement" class="btn btn-primary btn-lg submitfrm" id="" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Patienter...">Valider</a>
    ...
    <!-- Modal update -->
    <div class="modal fade bd-example-modal-lg" id="updatemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title" id="myModalLabel">Modifier Mouvement</h4>
                </div>
                <div class="modal-body">
                    <div class="alert alert-success" style="display: none">
                        <strong>Success!</strong> Indicates a successful or positive action.
                    ...
                    <form id="updatemovement" class="form-horizontal" role="form" enctype="multipart/form-data" action="movement/update" method="POST" >
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4 pull-right">
                                <a title="movement/update" alt="updatemovement" class="btn btn-primary btn-lg submitfrm" id="" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Patienter...">Valider</a>
                                <!-- <button   id="" type="submit" class="btn btn-primary">
                                     submit
                                 </button>-->
                                <!--<button id="submitfrm" title="movement/add" class="btn btn-primary btn-lg" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Patienter...">
